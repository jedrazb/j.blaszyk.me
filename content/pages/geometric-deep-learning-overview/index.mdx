...
_Figure 1: 2D Convolution vs. Graph Convolution._
...
<BlockMath
  math={`\\text{msg}(x_i, x_j) = \\frac{1}{\\sqrt{\\deg(x_i)} \\cdot \\sqrt{deg(x_j)}} \\cdot \\left( \\mathbf{x}\\_j\\mathbf{\\Theta} \\right)`}
></BlockMath>
...
_Figure 2: Semi-supervised node classification result on Cora dataset._
