...
images:
  [
    ...
    './photos/finish_1.jpeg',
    './photos/finish_2.jpeg',
    './photos/en_route.jpeg',
  ]
blogImages: []
---
  ...
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Karkonosze Pass uphill."
      />
    </Column>
    <Column flex={2.26}>
      <ImageComponent
        image={props.data.mdx.frontmatter.images[5]}
        description="Odrodzenie shelter in Karkonosze Pass."
      />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  <ImageComponent
    ...
    description="Crossing the finish line with dude.cycling."
    isRow
  />
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Gravmageddon 2023 Race Cap"
      />
    </Column>
    <Column>
      <ImageComponent
        image={props.data.mdx.frontmatter.images[14]}
        description="Gravmageddon 2023 Race Cap - top"
      />
    </Column>
  </Container>
</MakeItBigContainer>
...
<LazyIframe height="800px">
  <iframe
    width="800"
    height="450"
    src="https://www.youtube.com/embed/2StBCY2ATPQ?si=v2SgBPy4XXdosiQG"
  ...
  <Container>
    ...
    <Column>
      <ImageComponent
        ...
        description="Gravmageddon racing."
        isRow
      />
    </Column>
  </Container>
  <Container>
    <Column flex={1.7765}>
      <ImageComponent
        ...
        description="Canyon Grizl bike at the water reservoir"
        isRow
      />
    </Column>
    <Column>
