...
They don't only manufacture cargo bikes; they also build an [ecosystem of accessories](https://hazaybikes.com/en/accessories/) that enable eco-friendly and comfortable transport for anyone. Hazay Bikes offers a range of accessories for children (child seat and rain tent), dogs (dog carrier) and business (cargo box).
