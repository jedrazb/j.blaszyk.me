...
They don't only manufacture cargo bikes; they also build an [ecosystem of accessories](https://hazaybikes.com/en/accessories/) that enable eco-friendly and comfortable transport for anyone. They offer a range of accessories for children (child seat and rain tent), dogs (dog carrier) and business (cargo box).
  ...
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Child sear for cargo bike - Hazay Bikes"
        isRow
      ></ImageComponent>
    </Column>
    <Column>
      <ImageComponent
        ...
        description="Cargo bike rain tent - Hazay Bikes"
        isRow
      ></ImageComponent>
    </Column>
  </Container>
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Cargo bike dog carrier - Hazay Bikes"
      ></ImageComponent>
    </Column>
    <Column>
      <ImageComponent
        image={props.frontmatter.images[5]}
        description="Cargo bike box - Hazay Bikes"
      ></ImageComponent>
    </Column>
  </Container>
</MakeItBigContainer>
