...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[7]} alt="Route" isRow />
  <Container>
    <Column>
      <ImageComponent
...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[4]} alt="Camping 2" />
  <ImageComponent image={props.frontmatter.images[2]} alt="Camping 3" />
</MakeItBigContainer>
