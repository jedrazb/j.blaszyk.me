...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[15]} description="" />
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <Container>
    ...
    <Column>
      <ImageComponent image={props.frontmatter.images[5]} />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <Container>
    ...
    <Column>
      <ImageComponent image={props.frontmatter.images[44]} isRow />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <Container>
    ...
    <Column>
      <ImageComponent image={props.frontmatter.images[18]} isRow />
    </Column>
  </Container>
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[21]} />
    </Column>
    <Column>
      <ImageComponent
