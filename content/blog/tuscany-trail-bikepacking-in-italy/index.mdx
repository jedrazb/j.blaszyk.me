...
indexImage: './photos/bikepacking-tuscany-cover.jpg'
ogimage: './photos/20230515-DSCF4806.jpg'
...
<BikepackingDetails
  ...
  title={'Tuscany Trail Bikepacking'}
  distance={'490km'}
  elevation={'7300m'}
  time={'8 days'}
  date={'May 2023'}
...
<MakeItBigContainer>
  ...
  <Container>
    <Column>
      <ImageComponent
        image={props.data.mdx.frontmatter.images[42]}
...
<MakeItBigContainer>
  ...
  <Container>
    ...
    <Column>
      <ImageComponent image={props.data.mdx.frontmatter.images[44]} isRow />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <Container>
    ...
    <Column>
      <ImageComponent image={props.data.mdx.frontmatter.images[18]} isRow />
    </Column>
  </Container>
  <Container>
    <Column>
      <ImageComponent image={props.data.mdx.frontmatter.images[21]} />
    </Column>
    <Column>
      <ImageComponent
