---
title: 'Bikepacking in the Balkans: Montenegro and Albania'
date: '2024-09-22'
...
- [The Route](#the-route)
- [Montenegro](#bikepacking-in-montenegro)
- [Albania](#bikepacking-in-albania)

<MakeItBigContainer>
  <ImageComponent
    image={props.data.mdx.frontmatter.images[39]}
    description="Bikepacking in the Balkans"
  />
</MakeItBigContainer>
...
Thanks to my friends at [velomapa.pl](https://velomapa.pl/), this post is also available in [Polish](https://velomapa.pl/blog/bikepacking-na-balkanach). Enjoy your read!

## Bikepacking in the Balkans

<BikepackingDetails
  logo={props.data.mdx.frontmatter.logo}
  title={'Balkans Bikepacking'}
  distance={'580km'}
  elevation={'8800m'}
  time={'7 days'}
  date={'Sep 2024'}
  ...
  <Container>
    <Column>
      <ImageComponent
        ...
        isRow
        description="Bikepacking in Montengero: Kotor Bay"
      />
    </Column>
    <Column>
  ...
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Long climb starting in Kotor"
        isRow
      />
    </Column>
    <Column>
...
<MakeItBigContainer>
  <ThreePhotosContainer>
    <ImageComponent
      ...
      description="Bikepacking in Montenegro: Arriving to Bar"
      isRow
    />
  ...
  <Container>
    <Column>
      <ImageComponent
        ...
        description="Bikepacking in Albania: Albanian Alps"
      />
    </Column>
    <Column>
      <ImageComponent
  ...
  <Container>
    <Column flex={1.1115}>
      <ImageComponent
        ...
        description="Bikepacking Albanian Alps"
        isRow
      />
  ...
  <Container>
    <Column flex={1.1115}>
      <ImageComponent
        ...
        description="Bikepacking in Theth"
        isRow
      />
