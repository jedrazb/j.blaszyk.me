...
<ImageComponent image={props.frontmatter.blogImages[1]} alt="Windsor route" />
...
<ImageComponent image={props.frontmatter.blogImages[3]} alt="Box hill route" />
...
My friend Szymon and I decided to cycle to Oxford just to try [Moo-Moo's milkshakes](https://www.moo-moos.co.uk/), so don't forget to give it a go once you reach the city. I recommend going back to London by train.
