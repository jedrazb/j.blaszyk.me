...
<MakeItBigContainer>
  ...
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[5]} alt="Landing" />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[6]} alt="Georgios" />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  <Container>
    <Column flex={2}>
      <ImageComponent image={props.frontmatter.images[1]} alt="Planes" />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.blogImages[0]} alt="Pilot" />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.blogImages[3]} alt="Shortcut" />
    </Column>
    <Column>
      <ImageComponent
...
<MakeItBigContainer>
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[20]} alt="Tent" isRow />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[22]} alt="Cliffs" isRow />
    </Column>
  </Container>
  <ImageComponent
