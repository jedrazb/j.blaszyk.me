...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[47]} alt="Glacier Lagoon" />
</MakeItBigContainer>
...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[3]} alt="Clouds" isRow />
  <Container>
    <Column>
      <ImageComponent
    ...
    <Column>
      <ImageComponent image={props.frontmatter.images[0]} alt="Cliffs" isRow />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[24]} alt="Big foss" isRow />
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[22]} alt="Horses" isRow />
    </Column>
    <Column>
      <ImageComponent
  ...
  <ImageComponent
    ...
    isRow
  />
  <ImageComponent image={props.frontmatter.images[26]} alt="Plane" />
</MakeItBigContainer>
...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[32]} alt="Svartifoss" isRow />
  <Container>
    <Column>
      <ImageComponent
  ...
  <ImageComponent image={props.frontmatter.images[34]} alt="Glacier 3" isRow />
  <Container>
    <Column>
      <ImageComponent
  ...
  <ImageComponent image={props.frontmatter.images[37]} alt="Glacier 6" />
</MakeItBigContainer>
...
<MakeItBigContainer>
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[38]} alt="Jedr" isRow />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[39]} alt="Beach" isRow />
    </Column>
  </Container>
  <ImageComponent
  ...
  <ImageComponent
    ...
    isRow
  />
  <ImageComponent image={props.frontmatter.images[49]} alt="Icelandic road" />
</MakeItBigContainer>
...
<ImageGallery images={props.frontmatter.images}/>
