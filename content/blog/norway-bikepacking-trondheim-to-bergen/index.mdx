...
<MakeItBigContainer>
  <ImageComponent image={props.frontmatter.images[41]} description="" />
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <ThreePhotosContainer>
    <ImageComponent image={props.frontmatter.images[12]} isRow />
    <ImageComponent
  ...
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[7]} isRow />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[9]} isRow />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[10]} isRow />
    </Column>
  </Container>
</MakeItBigContainer>
...
<MakeItBigContainer>
  ...
  <ThreePhotosContainer>
    <ImageComponent
      ...
      isRow
    />
    <ImageComponent image={props.frontmatter.images[22]} noPadding />
    <ImageComponent image={props.frontmatter.images[25]} isRow />
  </ThreePhotosContainer>
</MakeItBigContainer>
...
<MakeItBigContainer>
  <ThreePhotosContainer>
    <ImageComponent
      ...
      isRow
    />
    <ImageComponent image={props.frontmatter.images[45]} noPadding />
    <ImageComponent image={props.frontmatter.images[46]} isRow />
  </ThreePhotosContainer>
  <Container>
    <Column>
      <ImageComponent image={props.frontmatter.images[49]} />
    </Column>
    <Column>
      <ImageComponent image={props.frontmatter.images[52]} isRow />
    </Column>
    <Column>
      <ImageComponent
