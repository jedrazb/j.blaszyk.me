---
title: 'Data Connectors - Elasticsearch Ingestion Made Simple'
date: '2023-09-26'
spoiler: Overview of a new data connectors framework integrated with the Elastic stack. Example of writing a custom connector to ingest data from any source into the Elasticsearch index.
blogImages: []
---
...
Therefore, in this post, I’m diving into ingestion mechanisms offered by Enterprise Search component in the Elastic stack:

- Crawler - It allows to ingest content of any website in a matter of a few clicks
- Data connectors - A new lightweight, fast, developer-friendly framework maintained by Elastic that allows you to keep any content source, e.g. database, cloud storage or local file system, in sync with Elasticsearch.

All of this can be ran locally or in the cloud, for the purpose of the blog I’ll be running Elastic stack as docker containers locally (docker-compose).
...
Here is a simple architecture of the service
