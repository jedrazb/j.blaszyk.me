...
**Graph.** A graph _G_ is a pair _(V,E)_ with the finite set of vertices _V_ and edges _E_. It captures interactions (edges) between individual units (nodes).
...
<ImageComponent image={props.frontmatter.blogImages[1]} alt="Cora dataset" />
