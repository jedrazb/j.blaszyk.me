...
In the next post, [Exploring Apache Lucene - Part 3: Running at Scale](/tech-blog/exploring-apache-lucene-at-scale/), I will investigate different architectures that make it possible to run Apache Lucene at scale.
