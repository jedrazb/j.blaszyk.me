...
We are living in the digital age - publishing content has never been easier thanks to social platform tech giants. After all, they do need to fill up the space on your feed with something, in between showing paid ads. The intrusive “recommendations”, on apps such as Instagram, made me effectively stop using them and rethink how I want my data to be shared.

Content type matters. Best holiday pictures from? Instagram. A bit more pictures from a bikepacking trip? Flickr. Career move or a success story? Linkedin. Wanna dive deeper into tech? Medium. Sharing a thought? Twitter. Facebook is just for groups and messages - as its wall feed became a big news/ads/e-commerce mixture. There seems to be no good solution that ticks all of the boxes to share any content you want, on your terms.
...
It’s because of my bikepacking trips, that I started feeling the need for a blog. I wanted to be able to tell this story, on my terms, without restrictions on how the content is organized and presented. I wanted my experience and painstakingly researched routes to be discoverable by anyone interested - in order to give back, hopefully, an inspiration, to the community. It's also a great way to reflect on your experience after doing something interesting.

And it worked! Take for example `"norway bikepacking"` search query in Google, you should find the story in the top 10 (or 20 depending on your location) results.

> [Norway Bikepacking: Trondheim to Bergen](https://j.blaszyk.me/norway-bikepacking-trondheim-to-bergen/)

The content is very important for being discoverable. But as a techie, I did my research to make sure all non-content related metrics will boost my blog in page rank algorithm: performance, SEO practices and mobile usability. I will go over the tech stack of my blog, and some design decisions which made this performant, customizable and completely free - the only recurring cost is a few dollars for the domain name.

Spoiler, here are the results from [pagespeed.web.dev](https://pagespeed.web.dev/) - a Google tool to measure overall website performance.
...
Check the source if you don't trust me!
